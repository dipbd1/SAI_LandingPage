...
import { X, ArrowRight, Moon } from 'lucide-react'
    ...
    return (
        <header className="lg:tw-px-4 tw-max-w-[100vw] tw-max-w-lg:tw-mr-auto max-lg:tw-top-0 tw-fixed tw-top-4 lg:tw-left-1/2 lg:tw--translate-x-1/2 tw-z-20 tw-flex tw-h-[60px] tw-w-full tw-text-gray-700 tw-bg-white dark:tw-text-gray-200 dark:tw-bg-[#17181b] tw-px-[3%] tw-rounded-md lg:tw-max-w-5xl tw-shadow-md dark:tw-shadow-gray-700 lg:tw-justify-around lg:!tw-backdrop-blur-lg lg:tw-opacity-[0.99]">
            <Link href="#" className="tw-flex tw-p-[4px] tw-gap-2 tw-place-items-center">
                <div className="tw-h-[26px] tw-max-w-[30px]">
                    <Image
                        src="/logo/logo.png"
                        alt="logo"
                        width={80}
            ...
            <div className="tw-hidden lg:tw-flex tw-items-center tw-gap-2">
                <nav className="tw-flex tw-gap-5 tw-text-base tw-place-items-center">
                    ...
                    {/*<Link href="/" className="header-links">Our Products</Link>*/}
                    {/*<Link href="/" className="header-links">About Us</Link>*/}
                    {/*<Link href="/" className="header-links">Careers</Link>*/}
                    {/*<Link href="/" className="header-links">Pricing</Link>*/}
                    {/*<Link href="/" className="header-links">Contact Us</Link>*/}
                </nav>
            ...
            {/* Mobile menu */}
            {isMenuOpen && (
                <div className="tw-fixed tw-inset-0 tw-bg-black/10 tw-backdrop-blur-sm tw-z-40 tw-pointer-events-none" onClick={toggleHeader}>
                    <div
                    ...
                    >
                        ...
                        <nav className="tw-flex tw-flex-col tw-gap-6 tw-p-6 tw-overflow-y-auto">
                            <Link href="#" className="tw-text-lg tw-text-zinc-400 hover:tw-text-zinc-100 tw-transition-colors" onClick={toggleHeader}>Home</Link>
                            <Link href="/who-we-are" className="tw-text-lg tw-text-zinc-400 hover:tw-text-zinc-100 tw-transition-colors" onClick={toggleHeader}>Who We Are</Link>

                            <Link href="/minion" className="tw-text-lg tw-text-zinc-400 hover:tw-text-zinc-100 tw-transition-colors" onClick={toggleHeader}>M.I.N.I.O.N</Link>
                            <Link href="/all-mark" className="tw-text-lg tw-text-zinc-400 hover:tw-text-zinc-100 tw-transition-colors" onClick={toggleHeader}>AllMark</Link>
                            <Link href="/why-choose-simple-ai" className="tw-text-lg tw-text-zinc-400 hover:tw-text-zinc-100 tw-transition-colors" onClick={toggleHeader}>Work With Us</Link>
                            ...
                            {/*    </div>*/}
                            {/*)}*/}
                            {/*<Link href="#" className="tw-text-lg tw-text-zinc-400 hover:tw-text-zinc-100 tw-transition-colors" onClick={toggleHeader}>Our Products</Link>*/}
                            {/*<Link href="#" className="tw-text-lg tw-text-zinc-400 hover:tw-text-zinc-100 tw-transition-colors" onClick={toggleHeader}>About Us</Link>*/}
                            {/*<Link href="#" className="tw-text-lg tw-text-zinc-400 hover:tw-text-zinc-100 tw-transition-colors" onClick={toggleHeader}>Careers</Link>*/}
                            {/*<Link href="#" className="tw-text-lg tw-text-zinc-400 hover:tw-text-zinc-100 tw-transition-colors" onClick={toggleHeader}>Pricing</Link>*/}
                            {/*<Link href="#" className="tw-text-lg tw-text-zinc-400 hover:tw-text-zinc-100 tw-transition-colors" onClick={toggleHeader}>Contact Us</Link>*/}
                        </nav>
